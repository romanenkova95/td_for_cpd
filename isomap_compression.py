...
train_dataset, test_dataset = datasets.CPDDatasets(
    experiments_name=experiments_name, compress_to=48
).get_dataset_()
...
metrics.write_metrics_to_file(
    path_to_saves + "result_metrics_isomap_conv2d_win4.txt", _, ""
)
...
plt.savefig(path_to_saves + "__isomap_conv2d_win4" + "curve.png")
